...
public class Hemisphere implements Spell, CreateBlocks {

	private static Component[] allowedComponents = { Component.AIR,
			Component.FIRE, Component.GLASS, Component.LEAVES, Component.WEB };
	...
	public Hemisphere(IPlayer player, Location origin, Material mat, byte data,
