...
public class Entomb implements Spell, CreateBlocks {
	...
	public Entomb(IPlayer player, Location origin, Material mat, byte data,
		...
		exp = EntityTools.getLivingEntitiesAroundPoint(origin, radius,
				caster.getPlayer()).size();
